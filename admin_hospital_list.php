		...
		<div class="container">
			...
			<nav>
					<ul>
						...
						<li class="current"><a href="admin_hospital_list.php">Hospital List</a></li>
		...
		<?php
			...
			if($a>0){
				while($row=mysqli_fetch_array($r)){
					//echo $row['id'];
					echo "<tr><td>".$row['id']."</td><td>".$row['hospital_name']."</td><td><a href=admin_hospital_list_delete.php?id=".$row['id'].">Delete</a></td></tr>";
					//echo "<tr><td><a href=admin_hospital_list_delete.php?id=".$row['id'].">Delete</a></td></tr>";
