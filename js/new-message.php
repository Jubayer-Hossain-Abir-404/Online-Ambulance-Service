<div id="new-message">
	...
	<p class="m-body">
		<form align="center" method="post">
			...
			class="message-input" placeholder="User Name"
			name="user_name" id="user_name"/>
			<!-- This data list will show available user -->
...
<?php
	...
	if(isset($_POST['send'])){
		...
		if($r){
			//message sent
			//echo "message sent";
			header("location:messages.php?user=".$receiver_name) ;
		}else{
			//query problem
			echo $q;
		} 
