...
<body>
		...
		<div class="container">
			...
			<nav>
					<ul>
						...
						<li class="current"><a href="admin_receiver_list.php">Service Receiver List</a></li>
	...
	<table>
		...
		<?php
			...
			$query= "select * from service_recipient";
			$r= mysqli_query($conn,$query);
			$a=mysqli_num_rows($r);
			if($a>0){
				while($row=mysqli_fetch_array($r)){
					//echo $row['id'];
					echo "<tr><td>".$row['id']."</td><td>".$row['user_name']."</td><td>".$row['email']."</td><td>".$row['phone_number']."</td><td><a href=admin_receiver_list_delete.php?id=".$row['id'].">Delete</a></td></tr>";
					//echo "<td><a href=admin_receiver_list_delete.php?id=".$row['id'].">Delete</a></td>";
