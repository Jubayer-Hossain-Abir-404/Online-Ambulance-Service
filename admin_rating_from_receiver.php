...
<body>
		...
		<div class="container">
			...
			<nav>
					<ul>
						...
						<li class="current"><a href="admin_rating_from_receiver.php">Receiver Rating</a></li>
	...
	<table>
		...
		<?php
			...
			$query= "select * from rate_system";
			$r= mysqli_query($conn,$query);
			$a=mysqli_num_rows($r);
			if($a>0){
				while($row=mysqli_fetch_array($r)){
					//echo $row['id'];
					echo "<tr><td>".$row['id']."</td><td>".$row['user_name']."</td><td>".$row['rate']."</td><td><a href=admin_rating_from_receiver_delete.php?id=".$row['id'].">Delete</a></td></tr>";
